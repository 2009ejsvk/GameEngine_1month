...
FCitizenLayoutMetrics MakeLayoutMetrics(bool IsCitizenMode)
{
    ...
    return
    {
        ...
        UIConfig::CitizenInfoLayoutDefaults::ActionGroupOffsetX,
        UIConfig::CitizenInfoLayoutDefaults::ActionGroupOffsetY,
        UIConfig::CitizenInfoLayoutDefaults::ActionGroupWidthAdd,
        UIConfig::CitizenInfoLayoutDefaults::ActionGroupHeightAdd,
        ActionIconInset,
        ActionIconSize,
