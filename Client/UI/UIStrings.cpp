...
namespace UIStrings
{
    namespace
    {
        ...
        const FDefaultEntry GDefaultEntries[] =
        {
            ...
            { L"citizen.politics.faction.economy.left", L"복지" },
            { L"citizen.politics.faction.economy.right", L"자본" },
            { L"citizen.politics.faction.religion_militarism.left", L"신앙" },
            { L"citizen.politics.faction.religion_militarism.right", L"군국" },
            ...
            { L"building.tourist_preference.celebrity", L"유명인" },
            { L"building.tourist_preference.unknown", L"미분류" },
            { L"building.resource_type.none", L"없음" },
            { L"building.resource_type.food", L"식량" },
            { L"building.resource_type.raw_goods", L"원자재" },
            { L"building.resource_type.manufactured_goods", L"공산품" },
            { L"building.resource_type.luxury_goods", L"사치품" },
            ...
            { L"almanac.politics.compact.economy.left", L"복지" },
            { L"almanac.politics.compact.economy.right", L"자본" },
            { L"almanac.politics.compact.religion_militarism.left", L"신앙" },
            { L"almanac.politics.compact.religion_militarism.right", L"군국" },
            ...
            { L"almanac.politics.verbose.economy.left", L"복지 우선" },
            { L"almanac.politics.verbose.economy.right", L"자본 우선" },
            { L"almanac.politics.verbose.religion_militarism.left", L"신앙 우선" },
            { L"almanac.politics.verbose.religion_militarism.right", L"군국 우선" },
            { L"almanac.politics.verbose.environment_industry.left", L"환경 우선" },
            { L"almanac.politics.verbose.environment_industry.right", L"산업 우선" },
            { L"almanac.politics.verbose.intellectual_conservative.left", L"지식 우선" },
            { L"almanac.politics.verbose.intellectual_conservative.right", L"보수 우선" },
