...
CCitizenInfoWidget::FRendererView CCitizenInfoWidget::GetRendererView()
{
    ...
    return
    {
        *this,
        ...
        Building.OverviewMetricIcons,
        Building.OverviewMetricLabels,
        Building.OverviewMetricValueBgs,
        ...
        Citizen.CitizenSubtitleTexts,
        Citizen.CitizenMetricLabels,
        Citizen.CitizenMetricValues,
